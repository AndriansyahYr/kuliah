...
class CartesianPanel extends JPanel {
 ...
 public static final int AXIS_STRING_DISTANCE = 20;
    ...
    private void doDrawing(Graphics g, double a, double b, double c,int val) {
        double fuzzy;
    ...
    public void alpaCut(Graphics g, double alfa, int val){
        ...
        double BB = -alfa*(this.c[val] - b[val])+c[val];
 ...
 public void paintComponent(Graphics g) {
  ...
  for(int i=0;i<jumlahGrafik;i++){
    doDrawing(g, this.a[i], this.b[i], this.c[i], i);
  }
  for(int i=0;i<jumlahGrafik;i++){
